...
export const config = {
  ...
  database: {
    url: process.env.DATABASE_URL || 'postgresql://postgres:password@localhost:5432/vehicle_db'
  },
  ...
  services: {
    ...
    clientStore: process.env.CLIENT_STORE_SERVICE_URL || 'http://localhost:3004',
