 ...
 * Handles HTTP requests related to city operations
 */

import { Request, Response } from 'express';
import { CityService } from '../services/cityService';
import { CreateCityRequest, UpdateCityRequest, CityFilters } from '../types/city';
...
export class CityController {
  ...
  static async getCities(req: Request, res: Response): Promise<void> {
    try {
      const filters: CityFilters = {
        ...
        isOperational: req.query.isOperational ? req.query.isOperational === 'true' : undefined,
   ...
   */
  static async getOperationalCities(req: Request, res: Response): Promise<void> {
    try {
