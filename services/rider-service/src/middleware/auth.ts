...
export const customCors = (req: Request, res: Response, next: NextFunction) => {
  const allowedOrigins = process.env.ALLOWED_ORIGINS?.split(",") || [
    ...
    "http://dashboard.ev91riderz.com", // Production admin dashboard
  ];
  ...
  res.setHeader(
    ...
    "Content-Type, Authorization, X-API-Key, X-Request-Id, Accept, Origin, X-Requested-With, Cache-Control, Pragma, Expires"
  );
