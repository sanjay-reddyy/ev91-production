...
import AddSparePartForm from '../components/spare-parts/AddSparePartForm'
...
const SpareParts: React.FC = () => {
  ...
  return (
    <Box p={3}>
                          ...
                          <TableCell>
                            <Box>
                              <Typography variant="body2" fontWeight="medium">
                                {formatCurrency(part.sellingPrice, part.currency)}
                              </Typography>
                              <Typography variant="caption" color="text.secondary">
                                Cost: {formatCurrency(part.costPrice, part.currency)}
                              </Typography>
                            </Box>
                          </TableCell>
                          <TableCell>
      ...
      {/* Add Part Dialog - Using AddSparePartForm component */}
      <AddSparePartForm 
        open={addDialogOpen} 
